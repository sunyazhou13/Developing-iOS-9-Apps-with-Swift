...
class FaceView: UIView {
    ...
    @IBInspectable
    var mouthCurvature: Double = 1.0  { didSet { self.setNeedsDisplay() } }
    @IBInspectable
    var eyesOpen: Bool = true  { didSet { self.setNeedsDisplay() } }
    @IBInspectable
    var eyeBrowTilt: Double = -0.5  { didSet { self.setNeedsDisplay() } }// -1 full furrow
    @IBInspectable
